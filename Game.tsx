...
import Board from "./Board";
import {BLtimer} from "./timer";
import { WLtimer } from "./timer";
...
export default function Game() {
  ...
  return (
    <>
      <BLtimer blackMin="4" blackTenSec="1" blackSec="2" blackMlSec="4"/>
      <BoardWrapper>
        <Board
          board={board}
      ...
      <br/>
      <WLtimer whiteMin="5" whiteTenSec="2" whiteSec="9" whiteMlSec="4"/>
    </>
  );
}
