...
function ResultDiv({result,clearLocal}:res) {
  return(
    ...
    <div style={{display:'flex',justifyContent:'center'}}>
      <div style={{display: result !== '*' ? 'flex' : 'none',flexDirection:'column',justifyContent:'space-between',alignItems:'center',width:'700px',height:'700px',backgroundColor:'green',position:'relative',bottom:'760px'}}>
